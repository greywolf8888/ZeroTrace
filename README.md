...
| Claim Verification | public tax/burn/LP/treasury/pension claims compared with replayable chain actions             | Evidence-bound statement compiler, deterministic allocation/action kernel, target-indexed Transfer/Safe observation, exact-block supply-conserved burn derivation, live FFT address-flow observations and durable Claim Report replay work; wide-range action discovery, official attribution, scheduling and terminal FFT acceptance pending |
...
- [ ] Add durable capture scheduling, wide-range action discovery, reviewed-draft promotion and terminal FFT audit
