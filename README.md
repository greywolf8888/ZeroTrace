...
instruction paths, and recorded SOL/SPL balance effects. It also returns bracketed Bitcoin address
...
| Solana             | Accounts, Token/Token-2022, instruction/CPI history, authorities, PDAs, launchpads and AMMs   | Snapshot-bound legacy/v0 transaction semantics with ALT resolution, account access, CPI and recorded SOL/SPL effects plus finalized atomic SPL Token/Token-2022/multisig/upgradeable-loader authority reports; program decoders, PDA/Squads recursion, authority history, IDL/build provenance, other loaders and archive reconciliation pending |
