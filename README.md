...
| Claim Verification | public tax/burn/LP/treasury/pension claims compared with replayable chain actions             | Deterministic allocation/action kernel distinguishes custody from burn and policy locks from technical locks; chain extraction, API/UI and FFT replay pending                                                                               |
...
- [ ] Bind claim extraction and chain observations to durable API/UI audit reports and FFT replay
