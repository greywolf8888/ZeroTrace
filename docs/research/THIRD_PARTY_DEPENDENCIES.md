...
| `pg`                         |  8.23.0 | pooled PostgreSQL access, durable reports/checkpoints and scheduler leases | MIT          | [brianc/node-postgres](https://github.com/brianc/node-postgres)                                   |
...
| `nats`                         | `2.11.17-alpine`               | event bus and JetStream          | Apache-2.0                                               | [nats-io/nats-server](https://github.com/nats-io/nats-server)         | separate service; capture-event adapter remains pending                                        |
...
| `temporalio/auto-setup`        | `1.29.7`                       | optional durable workflows       | MIT                                                      | [temporalio/temporal](https://github.com/temporalio/temporal)         | `full` profile sidecar; Schedule/Workflow adapter remains pending                              |
