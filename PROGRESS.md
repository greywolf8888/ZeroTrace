...
| Unit tests                       | **580 passing across 95 files**                                                                          |
| Model evaluation tests           | **1 structural Entity Precision/False-Merge gate passing**                                               |
| Integration tests                | **80 environment-free; 116/116 pass in disposable CI stores; local fresh PostgreSQL pass**               |
| Real-browser E2E                 | **36 passing: Chromium desktop and Pixel 7**                                                             |
| Remote CI                        | **Draft PR #20 passes CI and CodeQL; protected `main` remains `055daf9`**                                |
...
| Unit tests                     | 580 pass                                  | 95 files, including generic declaration review, durable report replay and finalized ERC-20 decimals observation plus raw-ledger Action compilation, persistence, scheduling and handler execution                                                                                                     |
| Integration tests              | 80 environment-free; 116/116 remote       | all PostgreSQL/ClickHouse/MinIO cases pass in disposable CI stores; a fresh local PostgreSQL passes migration 001-028, report restart equality and immutable-row checks                                                                                                                               |
...
| Remote CI                      | PR #20 green                              | [CI run 31556207071](https://github.com/greywolf8888/ZeroTrace/actions/runs/31556207071) and [CodeQL run 31556207064](https://github.com/greywolf8888/ZeroTrace/actions/runs/31556207064) passed through documentation acceptance commit `14f39c0`; protected main `055daf9` remains separately green |
