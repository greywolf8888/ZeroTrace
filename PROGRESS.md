...
| Remote CI                        | **Protected `main` `6f209a5` passed CI and CodeQL after PR #18**                                         |
| Coverage                         | **Remote durable: 82.38% statements / 76.60% branches / 93.24% functions / 83.49% lines**                |
...
| Coverage gate                  | Pass                                             | remote disposable-store run: 676/676 tests, 82.38% statements, 76.60% branches, 93.24% functions and 83.49% lines; local engine-free run passed 642 tests but correctly failed the durable threshold after 33 store cases skipped |
...
| Remote CI                      | Protected `main` `6f209a5` passed                | [CI run 31548486491](https://github.com/greywolf8888/ZeroTrace/actions/runs/31548486491) and [CodeQL run 31548486484](https://github.com/greywolf8888/ZeroTrace/actions/runs/31548486484) passed on the exact PR #18 squash merge |
