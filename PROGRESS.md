...
- Snapshot-pinned fork execution for the FFT buy-plus-pension-transfer path, including wallet receipt,
  transfer tax/swapback, final reserves, gas/revert behavior and any independently evidenced payout;
