...
| Unit tests                       | **471 passing across 71 files**                                                                                |
...
| Analyst UI                           | `PARTIALLY_IMPLEMENTED`                     | typed ledger/Evidence, EVM/Solana controls, Bitcoin UTXO/script boundaries, pension/claim/burn and market/RV panels work; terminal investigation remains incomplete                                                                         |
...
- the composed observer subsequently passed a live single-source run at finalized Snapshot block
  ...
  totals, dividend/action meaning, full sell/execution RV and terminal FFT acceptance remain
...
| Flap FFT terminal run  | BSC token `0xdcfb441a1f38802820a4e7b4cc8aab37833c7777`: mechanism, entity, market, RV, Evidence and automatic error audit | Transfer/Safe, durable pension-behavior discovery/replay, buy/exit, burn promotion, 37-check market/RV reconciliation, four-transition supply continuity, and scoped EVM proxy/source control passed. FFT is an ERC-1167 proxy with exact-verified `FlapTaxTokenV3` logic and zero-valued ERC-173 owner. The pension candidate is Evidence-backed behavior only; official attribution, no-exit/dividend action proof, effective authorization/history, full-history supply, fork settlement and entity calibration still gate a terminal conclusion |
...
| Unit tests                     | 471 pass                                      | 71 files across schemas, adapters, claim auditing, data quality, ingestion, storage, workers and API runtime      |
...
| Coverage gate                  | Pass                                          | durable run: 83.37% statements, 77.95% branches, 93.41% functions, 84.55% lines; all 568 tests passed             |
| Chromium E2E                   | 34 pass                                       | desktop and Pixel 7 include pension behavior, Solana semantics, controls, supply, market/RV, burn and Unknown     |
