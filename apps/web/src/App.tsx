                  ...
                  <article className="claim-draft-card" key={draft.id}>
                    ...
                    {review === undefined ? null : (
                      <div className="claim-review-result" role="status">
                        <div className="claim-draft-heading">
                          <div>
                            <span className="eyebrow">Immutable Expected rule</span>
      ...
      <section className="panel subject-panel" aria-labelledby="control-ledger-heading">
        <div className="panel-header">
          <div>
            ...
            <h3 id="control-ledger-heading">Select control domain</h3>
          </div>
          <StatusPill status="READ_ONLY" />
        </div>
...
function SolanaControlRightsWorkspace() {
    ...
    <>
      <div className="page-heading">
        <div>
          ...
          <h1>Solana Control Rights</h1>
          <p>
            Inspect SPL Token, Token-2022, classic multisig, and loader-v3 upgrade authority without
      ...
      <section className="panel subject-panel quote-panel" aria-labelledby="solana-control-heading">
        <div className="panel-header">
          <div>
            ...
            <h3 id="solana-control-heading">Control surface inspection</h3>
          </div>
          <span className="snapshot-badge">No signing or broadcast</span>
        </div>
        <form
        ...
        >
          <label htmlFor="solana-control-subject">Account or program address</label>
          <input
        ...
        <>
          <section className="panel" aria-labelledby="solana-control-result-heading">
            <div className="panel-header">
              <div>
                <span className="eyebrow">Immutable report {record.id}</span>
                <h3 id="solana-control-result-heading">Observed account surface</h3>
              </div>
          ...
          <section className="panel" aria-labelledby="solana-extension-heading">
            <div className="panel-header">
              <div>
                ...
                <h3 id="solana-extension-heading">Decoded extensions</h3>
              </div>
          ...
          <section className="panel" aria-labelledby="solana-right-list-heading">
            <div className="panel-header">
              <div>
                <span className="eyebrow">Positive Evidence only</span>
                <h3 id="solana-right-list-heading">Direct control rights</h3>
              </div>
              <span className="snapshot-badge">Point in time</span>
            </div>
            {report.rights.length === 0 ? (
          ...
          <section className="panel" aria-labelledby="solana-control-coverage-heading">
            <div className="panel-header">
              <div>
                <span className="eyebrow">Known false is not Unknown</span>
                <h3 id="solana-control-coverage-heading">Coverage matrix</h3>
              </div>
              <code>{record.terminalEvidenceId}</code>
            </div>
            <div className="table-scroll">
...
function LabelIntelligencePanel({ matches }: { matches: GlobalIntelligenceSearchMatch[] }) {
    ...
    <>
      <section className="panel label-intelligence-panel" data-testid="label-intelligence">
        ...
        <div className="label-audit-controls">
          ...
          <div className="label-audit-actions">
            ...
            >
              {busy ? 'Reading durable observations…' : 'Capture label audit'}
            </button>
          </div>
        </div>
        <div className="snapshot-strip">
        ...
        {record === undefined || intelligence === undefined ? (
          <div className="durable-search-empty label-audit-empty">
            <strong>No Label Snapshot loaded</strong>
            <p>Replay an existing report or capture the currently registered observation set.</p>
          </div>
        ) : (
          <>
            <div className="label-safety-grid" aria-label="Label inference safety boundaries">
              <div>
                <strong>Entity merge blocked</strong>
                <span>Labels are observations, never membership proofs.</span>
              </div>
              <div>
                <strong>Risk ≠ control</strong>
                <span>A risk label cannot establish a common controller.</span>
              </div>
              <div>
      ...
      {record === undefined ? null : (
        <EvidencePanel
          ...
          title="Label Intelligence evidence ledger"
        />
      )}
    </>
  );
